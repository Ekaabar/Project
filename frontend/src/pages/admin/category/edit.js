...
class EditCategoryAdmin extends Component {
  ...
  // associate every taped information to different properties
  handleSubmit(event) {
    event.preventDefault();

    API.put(`quiz/category/` + this.state.cat_id, {
      ...
      .then((res) => {
        this.props.navigate("/admin/quiz/" + this.state.quiz._id + "/view");
      })
      .catch((error) => {
        this.setState({
...
export default withParams(EditCategoryAdmin);
