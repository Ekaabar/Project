...
class NewQuestionChildAdmin extends Component {
    ...
    handleSubmit(event) {
        ...
        API.post(this.state.url_action_quest_child, formData, {
            headers: {
                        ...
                        <main role="main" className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                            ...
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <div className="form-group my-2">
                                    ...
                                    <Select required isMulti={this.state.selectedOptionCorrectIsMulti} onChange={this.handleChangeSelectOptionCorrect} options={this.state.options} value={this.state.selectedOptionCorrectValue} />
                                </div>
